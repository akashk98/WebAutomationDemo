...
public class HomeWork10 {
	...
	public static Logger log=Logger.getLogger("Output for seventh HomeWork");
		...
		static void launchBrowser()
		{
			try
			{
				log.info("Tenth Homework execution starts Here!!!");
		...
		static void User1logout()
		{
			try
			{
				oBrowser.findElement(By.linkText("Logout")).click();
				Thread.sleep(2000);
				log.info("User 1 logout Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void ModifyUser1() {
			try {
				...
				Thread.sleep(5000);
				log.info("User 1 Modified Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User1LogingAgain()
		{
			try
			{
				...
				oBrowser.findElement(By.xpath("//*[@id=\"welcomeScreenBoxId\"]/div[3]/div/span[1]")).click();
				Thread.sleep(3000);
				log.info("Modified user 1 login Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void ModifyUser2() {
			try {
				...
				oBrowser.findElement(By.xpath("//*[@id=\"userDataLightBox_commitBtn\"]")).click();
				Thread.sleep(5000);
				log.info("User 2 modified Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User1logoutAgain()
		{
			try
			{
				oBrowser.findElement(By.linkText("Logout")).click();
				Thread.sleep(2000);
				log.info("Modified user 1 logout Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User2LogingAgain()
		{
			try
			{
				...
				oBrowser.findElement(By.xpath("//*[@id=\"welcomeScreenBoxId\"]/div[3]/div/span[1]")).click();
				Thread.sleep(3000);
				log.info("Modified user 2 login Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void ModifyUser3() {
			try {
				...
				oBrowser.findElement(By.xpath("//*[@id=\"userDataLightBox_commitBtn\"]")).click();
				Thread.sleep(5000);
				log.info("User 3 Modified Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User2LogoutAgain()
		{
			try
			{
				oBrowser.findElement(By.linkText("Logout")).click();
				Thread.sleep(2000);
				log.info("Modified user 2 logout Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User2LogingAgainAgain()
		{
			try
			{
				...
				oBrowser.findElement(By.xpath("//*[@id=\"welcomeScreenBoxId\"]/div[3]/div/span[1]")).click();
				Thread.sleep(3000);
				log.info("login user2 Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User2LogoutAgainAgain()
		{
			try
			{
				oBrowser.findElement(By.linkText("Logout")).click();
				Thread.sleep(2000);
				log.info("logout User 2  Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User1LogingAgainAgain()
		{
			try
			{
				...
				oBrowser.findElement(By.xpath("//*[@id=\"welcomeScreenBoxId\"]/div[3]/div/span[1]")).click();
				Thread.sleep(3000);
				log.info("login User 1  Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void deleteUser2()
		{
			try
			{
				...
				oAlert.accept();
				Thread.sleep(2000);
				log.info("delete user2 Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void User1logoutAgainAgain()
		{
			try
			{
				oBrowser.findElement(By.linkText("Logout")).click();
				Thread.sleep(2000);
				log.info("User1 logout Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void Admin1loginAgain()
		{
			try
			{
				...
				oBrowser.findElement(By.xpath("//*[@id='loginButton']/div")).click();
				Thread.sleep(2000);
				log.info("admin again login Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
		...
		static void Admin1logoutAgainAgain()
		{
			try
			{
				oBrowser.findElement(By.linkText("Logout")).click();
				Thread.sleep(2000);
				log.info("Admin again logout Successfully!!!");
			}catch(Exception e)
			{
				e.printStackTrace();
			}
