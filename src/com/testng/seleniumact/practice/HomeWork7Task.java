...
static void AddTask() {
	try {
		...
		Thread.sleep(1000);
		oBrowser.findElement(By.id("ext-gen150")).click();
		Thread.sleep(1000);
		oBrowser.findElement(By.id("ext-gen284")).click();
		Thread.sleep(2000);
		oBrowser.findElement(By.xpath("//*[@id=\"createTasksPopup_createTasksTableContainer\"]/table/tbody/tr[1]/td[1]/input")).sendKeys("Project1");
		Thread.sleep(2000);
